<table id="yr25">
    <tbody>
        ...
        <tr>
            ...
            <td data-cell="D4"></td>
            <td data-cell="E4"></td>
            <td class="sps-bgblue sps-textwhite">
        ...
        <tr>
            <td data-cell="A48"></td>
            <td data-cell="B48" class="sps-bold"></td>
            <td data-cell="C48" class="sps-bold"></td>
            <td data-cell="D48"></td>
            <td data-cell="E48" class="sps-bold"></td>
            <td data-cell="F48" class="sps-bold"></td>
            <td data-cell="G48"></td>
            <td data-cell="H48" class="sps-bold"></td>
            <td data-cell="I48"></td>
        </tr>
    </tbody>
</table>